...
Route::middleware('frameguard')->group(function () {
   ...
   Route::get('/test-dtr', [DailyTimeRecordController::class, 'calculateEmployeeTimeDIff']);
   ...
   Route::middleware(['auth:sanctum'])->group(function () {
      ...
      Route::post('/update-member-information/{id}', [UserController::class, 'update_member_information']);
